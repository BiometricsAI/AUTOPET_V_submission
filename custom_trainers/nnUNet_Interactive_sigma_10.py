...
#  TRAINER
# ============================================================================
class nnUNetTr4_Interactive1(nnUNetTrainer):
    ...
    def __init__(self, plans, configuration, fold, dataset_json, device=torch.device('cuda')):
        ...
        self.path_pretrained_l4 = os.path.join(
            ...
            "nnUNetTr3_PreTr__nnUNetPlans__3d_fullres",
    ...
    def build_network_architecture(plans_manager, configuration_manager,
        ...
        base = nnUNetTrainer.build_network_architecture(
            ...
            nnUNetTr4_Interactive1.N_IMAGE,
            nnUNetTr4_Interactive1.N_LESION + N_ORGAN_CLASSES,
            enable_deep_supervision)
        return InteractiveL4Net(
            base, n_image=nnUNetTr4_Interactive1.N_IMAGE,
            guidance_channels=nnUNetTr4_Interactive1.N_GUIDANCE,
            n_lesion=nnUNetTr4_Interactive1.N_LESION, n_organ=N_ORGAN_CLASSES,
